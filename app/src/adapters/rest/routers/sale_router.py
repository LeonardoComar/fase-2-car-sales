...
@sale_router.post(
    ...
    description="Cria uma nova venda no sistema com os dados fornecidos.",
    responses={
...
@sale_router.get(
    ...
    description="Retorna os dados de uma venda específica pelo seu ID.",
    responses={
...
@sale_router.patch(
    ...
    description="Confirma uma venda alterando seu status para 'Confirmada'.",
    responses={
...
@sale_router.get(
    ...
    description="Lista vendas com filtros opcionais para busca avançada.",
    responses={
...
@sale_router.get(
    ...
    description="Lista todas as vendas de um funcionário específico.",
    responses={
...
@sale_router.get(
    ...
    description="Retorna estatísticas detalhadas das vendas com filtros opcionais.",
    responses={
